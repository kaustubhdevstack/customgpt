        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Extract Keywords</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Extract Keywords form Paragraphs!</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <?= form_open('tools/extract_keyword'); ?>
                ...
                <div class="form-group row">
                        <div class="col-sm-12">
                        <label for="addPrompt">Copy & Paste Paragraph</label>
                                <textarea name="describe" value="<?= set_value('describe'); ?>" class="form-control" id="addPrompt" placeholder="Paste content here.." required></textarea>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <a href="<?= base_url('tools/extract_keyword'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
