        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/review_code'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Code Reviewer</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Get your code reviewed</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <a href="<?= base_url('tools/review_code'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
