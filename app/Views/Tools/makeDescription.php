        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/description_maker'); ?>">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Create general description for anything!</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <?= form_open('tools/description_maker'); ?>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    <button type="submit" class="btn btn-primary">Get a description</button>
                    <a href="<?= base_url('tools/description_maker'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
