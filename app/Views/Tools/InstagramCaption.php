...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Insta Caption Maker</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/insta_captions_maker'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Insta Caption Maker</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Get captions for your instagram posts!</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <?= form_open('tools/insta_captions_maker'); ?>
                ...
                <div class="form-group row">
                        <div class="col-sm-12">
                        <label for="addPrompt">What is your post about?</label>
                                <textarea name="describe" value="<?= set_value('describe'); ?>" class="form-control" id="addPrompt" placeholder="My instagram post is on.." required></textarea>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    <button type="submit" class="btn btn-primary">Get captions</button>
                    <a href="<?= base_url('tools/insta_captions_maker'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
