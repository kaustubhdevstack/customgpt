        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/meme_maker'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Meme Maker</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Create a Meme</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <div class="form-group row">
                        <div class="col-sm-12">
                        <label for="addPrompt">Why do you want a meme?</label>
                                <textarea name="describe" value="<?= set_value('describe'); ?>" class="form-control" id="addPrompt" placeholder="I want a meme because.." required></textarea>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    ...
                    <a href="<?= base_url('tools/meme_maker'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
