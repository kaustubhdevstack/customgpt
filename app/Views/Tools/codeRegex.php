        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/regex_maker'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Regex Maker</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Generate Regular Expressions for Validations</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <div class="form-group row">
                        ...
                        <label for="addPrompt">Write proper instructions</label>
                                <textarea name="describe" value="<?= set_value('describe'); ?>" class="form-control" id="addPrompt" placeholder="Explain what kind of Validations you want" required></textarea>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    <button type="submit" class="btn btn-primary">Generate Validations</button>
                    <a href="<?= base_url('tools/regex_maker'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
