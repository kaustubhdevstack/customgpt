        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/outline_maker'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Outline Maker</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Create a flow or outline for content</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    <button type="submit" class="btn btn-primary">Get an outline</button>
                    <a href="<?= base_url('tools/outline_maker'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
