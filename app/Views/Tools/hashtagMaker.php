        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('tools/hashtag_maker'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Hashtag Maker</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Generate some hashtag for your posts</h3>
            </div>
            <!-- /.card-header -->
            ...
            <div class="card-footer">
                ...
                <div class="form-group row">
                        ...
                        <label for="addPrompt">What is your post about?</label>
                                <textarea name="describe" value="<?= set_value('describe'); ?>" class="form-control" id="addPrompt" placeholder="My social media post is on.." required></textarea>
                ...
                <div class="form-group row">
                  <div class="col-sm-12">
                    <button type="submit" class="btn btn-primary">Get hashtags</button>
                    <a href="<?= base_url('tools/hashtag_maker'); ?>" class="btn btn-dark">Cancel</a>
                  </div>
                </div>
